...
public class welcome extends JFrame {
	...
	welcome(){
        ...
        ImageIcon imageIcon = new ImageIcon(new ImageIcon("D:\\applications\\eclipse\\ehub\\src\\techfoss.jpeg").getImage().getScaledInstance(200, 200, 10));
        logo.setBorder(brd);
		...
		JLabel note= new JLabel("Welcome to TechFoss,  sign up for the best software solutions! ");
		 ...
		 panel.add(cont);
		    ...
		    user= new JButton();
	        ImageIcon image = new ImageIcon(new ImageIcon("D:\\applications\\eclipse\\ehub\\src\\profile2.png").getImage().getScaledInstance(110, 110, Image.SCALE_DEFAULT));
	        user.setBorder(brd);
	        user.setIcon(image);
			...
			panel.add(user);
			    ...
			    admin= new JButton();
		        ImageIcon images = new ImageIcon(new ImageIcon("D:\\applications\\eclipse\\ehub\\src\\profile2.png").getImage().getScaledInstance(110, 110, Image.SCALE_DEFAULT));
		        admin.setBorder(brd);
